...
int main()
{
	...
	String path1 = "Images/map-winter.png";
	...
	while (window.isOpen())
	{
		...
		clock.restart();
		time = time / 1000; //auei 800, ia iii?aaeony - aa?i?i
		...
		sf::Vector2i localPosition = Mouse::getPosition(); //ieoaai n?aa eii?aeiaou eo?ni?a
